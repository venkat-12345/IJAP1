...
namespace IJAP_MVC.Controllers
{
    public class JobPostController : Controller
    {
        ...
        EmpPostRepoAsync empPostRepo1 = new EmpPostRepoAsync();
        ...
        {
            EmployeePost employeePost = await empPostRepo1.GetEmpPostByIdAsync(id);
            employeePost.ApplicationStatus = "Accepted";
           
            // TODO: Add update logic here
            await empPostRepo1.UpdateEmpPostAsync(id, employeePost);
            Requests();

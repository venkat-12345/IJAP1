...
namespace EmpPostSvc.Controllers
{
    //[Authorize]
    public class EmployeePostController : ApiController
    {
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetOne(int eno)
        {
            try
            {
        ...
        [Route("api/EmployeePost/{eno}")]
        [HttpPut]
        public async Task<IHttpActionResult> Update(int eno, EmployeePost empPost)
        {
        ...
        [Route("api/EmployeePost/{eno}")]
        [HttpDelete]
        public async Task<IHttpActionResult> Delete(int eno)
        {
